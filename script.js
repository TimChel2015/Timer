(() => {
    ...
    const DEFAULT_NOTIFY_MODE = "notification_only";
    ...
    const I18N = {
      ru: {
        ...
        themeLight: "Светлая",
        themeDark: "Тёмная",
        themeSwitchLabel: "Тема оформления",
        ...
        confirmClearTimer: "Вы уверены, что хотите удалить таймер?",
        confirmDeviceNotification: "Разрешить уведомления на устройстве, когда таймер завершится?",
      clearTimerButton: "Удалить таймер",
      ...
      en: {
        ...
        confirmClearTimer: "Are you sure you want to delete this timer?",
        confirmDeviceNotification: "Allow device notifications when the timer finishes?",
      clearTimerButton: "Delete timer",
      ...
      uk: {
        ...
        themeLight: "Світла",
        themeDark: "Темна",
        themeSwitchLabel: "Тема оформлення",
        ...
        notifyModeOff: "Без повідомлення",
        ...
        confirmClearTimer: "Ви впевнені, що хочете видалити таймер?",
        confirmDeviceNotification: "Дозволити сповіщення на пристрої, коли таймер завершиться?",
      clearTimerButton: "Видалити таймер",
      ...
      de: {
        ...
        confirmClearTimer: "Mochtest du den Timer wirklich loschen?",
        confirmDeviceNotification: "Geraetebenachrichtigungen erlauben, wenn der Timer endet?",
      clearTimerButton: "Timer löschen",
      ...
      fr: {
        ...
        confirmClearTimer: "Voulez-vous vraiment supprimer le minuteur ?",
        confirmDeviceNotification: "Autoriser les notifications sur l'appareil a la fin du minuteur ?",
      clearTimerButton: "Supprimer le minuteur",
      ...
      es: {
        ...
        confirmClearTimer: "Estas seguro de que deseas eliminar el temporizador?",
        confirmDeviceNotification: "Permitir notificaciones en el dispositivo cuando termine el temporizador?",
      clearTimerButton: "Eliminar temporizador",
      ...
      it: {
        ...
        notifyModeOff: "Nessun messaggio",
        ...
        confirmClearTimer: "Vuoi davvero eliminare il timer?",
        confirmDeviceNotification: "Consentire le notifiche sul dispositivo quando il timer termina?",
      clearTimerButton: "Elimina timer",
      ...
      pt: {
        ...
        confirmClearTimer: "Tem certeza de que deseja excluir o temporizador?",
        confirmDeviceNotification: "Permitir notificacoes no dispositivo quando o temporizador terminar?",
      clearTimerButton: "Excluir temporizador",
        notifyTitle: "Temporizador finalizado",
      ...
      pl: {
        ...
        confirmClearTimer: "Czy na pewno chcesz usunac licznik?",
        confirmDeviceNotification: "Zezwolic na powiadomienia na urzadzeniu po zakonczeniu licznika?",
      clearTimerButton: "Usun licznik",
      ...
      tr: {
        ...
        confirmClearTimer: "Sayaci silmek istediginize emin misiniz?",
        confirmDeviceNotification: "Sayac bittiginde cihaz bildirimlerine izin verilsin mi?",
      clearTimerButton: "Sayaci sil",
      ...
      ar: {
        ...
        confirmClearTimer: "هل انت متأكد من حذف العداد؟",
        confirmDeviceNotification: "السماح بالاشعارات على الجهاز عند انتهاء العداد؟",
      clearTimerButton: "حذف العداد",
      ...
      he: {
        ...
        confirmClearTimer: "בטוחים שרוצים למחוק את הטיימר?",
        confirmDeviceNotification: "לאפשר התראות במכשיר כשהטיימר מסתיים?",
      clearTimerButton: "מחק טיימר",
      ...
      zh: {
        ...
        confirmClearTimer: "确定要删除此计时器吗？",
        confirmDeviceNotification: "计时结束时允许设备通知吗？",
      clearTimerButton: "删除计时器",
        notifyTitle: "计时结束",
      ...
      ja: {
        ...
        confirmClearTimer: "タイマーを削除してもよろしいですか？",
        confirmDeviceNotification: "タイマー終了時にデバイス通知を許可しますか？",
      clearTimerButton: "タイマーを削除",
        notifyTitle: "タイマー終了",
      ...
      ko: {
        ...
        confirmClearTimer: "타이머를 삭제하시겠습니까?",
        confirmDeviceNotification: "타이머가 끝날 때 기기 알림을 허용하시겠습니까?",
      clearTimerButton: "타이머 삭제",
        notifyTitle: "타이머 종료",
    ...
    const dom = {
      ...
      clearTimerButton: document.getElementById("clear-timer-button"),
      parts: {
  ...
  init();
    ...
    if (dom.clearTimerButton) {
      dom.clearTimerButton.addEventListener("click", onClearTimer);
    }
    }
    ...
    function onFormSubmit(event) {
      ...
      if (
        ...
        maybeAskDeviceNotificationPermission();
      }
  ...
  function onClearTimer() {
    ...
    const accepted = window.confirm(t("confirmClearTimer"));
    if (!accepted) {
      return;
    }
  ...
  function setClearButtonEnabled(enabled) {
    ...
    dom.clearTimerButton.disabled = !enabled;
    dom.clearTimerButton.textContent = t("clearTimerButton");
  }
  ...
  function setEmptyState() {
    ...
    function maybeAskDeviceNotificationPermission() {
      ...
      const accepted = window.confirm(t("confirmDeviceNotification"));
      if (accepted) {
    ...
    function updateThemeSwitchUI(isDark) {
      if (dom.themeLightBtn) {
        dom.themeLightBtn.classList.toggle("theme-switch__btn--active", !isDark);
        dom.themeLightBtn.setAttribute("aria-pressed", String(!isDark));
      }
      if (dom.themeDarkBtn) {
        dom.themeDarkBtn.classList.toggle("theme-switch__btn--active", isDark);
        dom.themeDarkBtn.setAttribute("aria-pressed", String(isDark));
      }
    }

    function updateThemeLabels(langSet) {
      if (dom.themeLightLabel) {
        dom.themeLightLabel.textContent = langSet.themeLight || "Light";
      }
      if (dom.themeDarkLabel) {
        dom.themeDarkLabel.textContent = langSet.themeDark || "Dark";
      }
      if (dom.themeSwitch) {
        dom.themeSwitch.setAttribute("aria-label", langSet.themeSwitchLabel || "Theme");
      }
    }
    ...
    function showDeviceNotification() {
      if (!("Notification" in window) || !currentEvent) {
        return;
      }
  
      const title = t("notifyTitle");
      const body = t("notifyBody").replace("{event}", currentEvent.title);
    ...
    setClearButtonEnabled(Boolean(currentEvent));
    ...
    function getSupportedNotifyMode(mode) {
      const modes = ["notification_only", "no_notification"];
