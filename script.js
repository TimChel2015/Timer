(() => {
  ...
  const I18N = {
    ...
    fr: {
      ...
      statusPaused: "Minuteur en pause",
    ...
    pt: {
      ...
      pauseButton: "Pausar",
      resumeButton: "Continuar",
      statusPaused: "Temporizador pausado",
      notifyTitle: "Temporizador finalizado",
    ...
    pl: {
      ...
      pauseButton: "Pauza",
      resumeButton: "Wznow",
      statusPaused: "Licznik wstrzymany",
    ...
    tr: {
      ...
      statusPaused: "Sayac duraklatildi",
    ...
    ar: {
      ...
      pauseButton: "ايقاف مؤقت",
      resumeButton: "متابعة",
      statusPaused: "العداد متوقف مؤقتا",
  ...
  function bindEvents() {
    ...
    if (dom.pauseButton) {
      dom.pauseButton.addEventListener("click", onPauseToggle);
    }
  }
  ...
  function onFormSubmit(event) {
    ...
    if (
      ...
      // Второе окно на выбранном языке: разрешение уведомлений на устройстве.
  ...
  function onPauseToggle() {
    ...
    if (isPaused) {
      ...
      dom.statusMessage.textContent = t("statusPaused");
    } else {
  ...
  function updatePauseButtonText() {
    ...
    dom.pauseButton.textContent = isPaused ? t("resumeButton") : t("pauseButton");
  }
  ...
  function initTheme() {
    ...
    // По умолчанию светлая тема (как на скриншоте).
    if (savedTheme === "dark") {
  ...
  function applyLanguage(lang) {
    ...
    if (!currentEvent) {
      ...
      dom.statusMessage.textContent = langSet.statusPaused;
